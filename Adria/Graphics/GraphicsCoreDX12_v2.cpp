#include "GraphicsCoreDX12_v2.h"

namespace adria
{

	GraphicsCoreDX12_v2::GraphicsCoreDX12_v2(void* window_handle)
	...
	GraphicsCoreDX12_v2::~GraphicsCoreDX12_v2()
	{
		WaitForGPU();
		ProcessReleaseQueue();
	...
	void GraphicsCoreDX12_v2::WaitForGPU()
	{
	...
	void GraphicsCoreDX12_v2::ResizeBackbuffer(UINT w, UINT h)
	{
	...
	UINT GraphicsCoreDX12_v2::BackbufferIndex() const
	{
		return backbuffer_index;
	}

	void GraphicsCoreDX12_v2::SetBackbuffer(ID3D12GraphicsCommandList* cmd_list /*= nullptr*/)
	{
	...
	void GraphicsCoreDX12_v2::ClearBackbuffer()
	{
	...
	void GraphicsCoreDX12_v2::SwapBuffers(bool vsync /*= false*/)
	{
		auto& frame_resources = GetFrameResources();
	...
	ID3D12Device5* GraphicsCoreDX12_v2::GetDevice() const
	{
		return device.Get();
	}

	ID3D12GraphicsCommandList4* GraphicsCoreDX12_v2::GetDefaultCommandList() const
	{
		return GetFrameResources().default_cmd_list.Get();
	}

	ID3D12GraphicsCommandList4* GraphicsCoreDX12_v2::GetNewGraphicsCommandList() const
	{
		auto& frame_resources = GetFrameResources();
	...
	ID3D12GraphicsCommandList4* GraphicsCoreDX12_v2::GetLastGraphicsCommandList() const
	{
		auto& frame_resources = GetFrameResources();
		unsigned int i = frame_resources.cmd_list_index.load();
	...
	ID3D12GraphicsCommandList4* GraphicsCoreDX12_v2::GetNewComputeCommandList() const
	{
		auto& frame_resources = GetFrameResources();
	...
	ID3D12GraphicsCommandList4* GraphicsCoreDX12_v2::GetLastComputeCommandList() const
	{
		auto& frame_resources = GetFrameResources();
		unsigned int i = frame_resources.compute_cmd_list_index.load();
	...
	void GraphicsCoreDX12_v2::ResetDefaultCommandList()
	{
		auto& frame_resources = GetFrameResources();
	...
	void GraphicsCoreDX12_v2::ExecuteDefaultCommandList()
	{
		auto& frame_resources = GetFrameResources();
	...
	D3D12MA::Allocator* GraphicsCoreDX12_v2::GetAllocator() const
	{
		return allocator.get();
	}

	void GraphicsCoreDX12_v2::AddToReleaseQueue(D3D12MA::Allocation* alloc)
	{
		release_queue.emplace(new ReleasableResource(alloc), release_queue_fence_value);
	}

	void GraphicsCoreDX12_v2::AddToReleaseQueue(ID3D12Resource* resource)
	{
		release_queue.emplace(new ReleasableResource(resource), release_queue_fence_value);
	}

	LinearDescriptorAllocator* GraphicsCoreDX12_v2::GetDescriptorAllocator() const
	{
		return descriptor_allocators[backbuffer_index].get();
	}

	LinearUploadBuffer* GraphicsCoreDX12_v2::GetUploadBuffer() const
	{
		return upload_buffers[backbuffer_index].get();
	}

	void GraphicsCoreDX12_v2::GetTimestampFrequency(UINT64& frequency) const
	{
		graphics_queue->GetTimestampFrequency(&frequency);
	}

	GraphicsCoreDX12_v2::FrameResources& GraphicsCoreDX12_v2::GetFrameResources()
	{
		return frames[backbuffer_index];
	}

	GraphicsCoreDX12_v2::FrameResources const& GraphicsCoreDX12_v2::GetFrameResources() const
	{
		return frames[backbuffer_index];
	}

	void GraphicsCoreDX12_v2::ExecuteGraphicsCommandLists()
	{
		auto& frame_resources = GetFrameResources();
	...
	void GraphicsCoreDX12_v2::ExecuteComputeCommandLists()
	{
		auto& frame_resources = GetFrameResources();
	...
	void GraphicsCoreDX12_v2::MoveToNextFrame()
	{
	...
	void GraphicsCoreDX12_v2::ProcessReleaseQueue()
	{
