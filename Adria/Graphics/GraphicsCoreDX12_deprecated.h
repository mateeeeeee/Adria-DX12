...
namespace adria
{
	...
	class [[deprecated]] GraphicsCoreDX12_deprecated
	{
	...
	public:
        ...
        GraphicsCoreDX12_deprecated(void* window_handle);
        GraphicsCoreDX12_deprecated(GraphicsCoreDX12_deprecated const&) = delete;
        GraphicsCoreDX12_deprecated(GraphicsCoreDX12_deprecated&&) = default;
        ~GraphicsCoreDX12_deprecated();
