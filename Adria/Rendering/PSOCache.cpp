	...
	namespace
	{
		...
		void CreateAllPSOs()
		{
			GraphicsPipelineStateDesc gfx_pso_desc{};
			{
				...
				gfx_pso_desc = {};
				gfx_pso_desc.root_signature = ERootSignature::AO;
				gfx_pso_desc.VS = VS_ScreenQuad;
				...
				gfx_pso_map[EPipelineState::HBAO] = std::make_unique<GraphicsPipelineState>(gfx, gfx_pso_desc);
				
				gfx_pso_desc = {};
				gfx_pso_desc.root_signature = ERootSignature::SSR;
				gfx_pso_desc.VS = VS_ScreenQuad;
				...
				gfx_pso_desc = {};
				gfx_pso_desc.root_signature = ERootSignature::Fog;
				gfx_pso_desc.VS = VS_ScreenQuad;
				...
				gfx_pso_desc = {};
				gfx_pso_desc.root_signature = ERootSignature::DOF;
				gfx_pso_desc.VS = VS_ScreenQuad;
				...
				gfx_pso_desc = {};
				gfx_pso_desc.root_signature = ERootSignature::MotionBlur;
				gfx_pso_desc.VS = VS_ScreenQuad;
				...
				gfx_pso_desc = {};
				gfx_pso_desc.root_signature = ERootSignature::VelocityBuffer;
				gfx_pso_desc.VS = VS_ScreenQuad;
