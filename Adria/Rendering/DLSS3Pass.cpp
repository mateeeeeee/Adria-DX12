...
namespace adria
{
	static TAutoConsoleVariable<bool> dlss3_enabled("r.DLSS3", true, "Enable or Disable DLSS3");
		...
		GUI_Command([&]()
			{
				...
				{
					ImGui::Checkbox("Enable", dlss3_enabled.GetPtr());
					if (dlss3_enabled.Get())
					{
