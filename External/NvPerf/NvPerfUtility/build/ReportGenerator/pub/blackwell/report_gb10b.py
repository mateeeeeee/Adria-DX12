...
import pub.blackwell.tables_gb10b as tables_gb10b

def get_per_range_report_definition_impl(tables_gb10b, tables_common):
    sections = [
        DataSection([
            tables_gb10b.DevicePropertiesGenerator().make_data_table(),
        ...
        DataSection([
            ...
            tables_gb10b.TopThroughputsGenerator().make_data_table(),
            tables_common.CacheHitRates().make_data_table(),
        ], title='Overview Section'),
        DataSection([
            tables_gb10b.L2TrafficByMemoryApertureShortBreakdownGenerator(show_generic_workflow=True).make_data_table(),
            tables_gb10b.L2TrafficBySrcBreakdownGenerator(show_generic_workflow=False).make_data_table(),
        ...
        DataSection([
            tables_gb10b.SmThroughputsGenerator().make_data_table(),
            tables_gb10b.SmInstExecutedGenerator().make_data_table(),
            tables_common.SmShaderExecutionGenerator().make_data_table(),
            tables_gb10b.SmResourceUsageGenerator().make_data_table(),
            tables_common.SmWarpLaunchStallsGenerator().make_data_table(),
            tables_gb10b.WarpIssueStallsGenerator().make_data_table(),
        ], title='Shader Performance Section'),
        DataSection([
            tables_common.PrimitiveDataflowGenerator().make_data_table(),
            tables_gb10b.RasterDataflowGenerator().make_data_table(),
        ], title='3D Pipeline Section'),
        DataSection([
            tables_gb10b.L2TrafficByMemoryApertureBreakdownGenerator(show_generic_workflow=False).make_data_table(),
            tables_gb10b.L2TrafficByOperationBreakdownGenerator(show_generic_workflow=False).make_data_table(),
        ], title='Additional L2 Traffic Breakdowns Section'),
        DataSection([
            tables_gb10b.AdditionalMetricsGenerator().make_data_table(),
...
def get_per_range_report_definition():
    return get_per_range_report_definition_impl(tables_gb10b, tables_common)

def get_summary_report_definition_impl(tables_gb10b, tables_common):
    sections = [
        DataSection([
            tables_common.CollectionInfoGenerator().make_data_table(),
        ]),
        DataSection([
            tables_gb10b.RangesSummaryGenerator().make_data_table(),
...
def get_summary_report_definition():
    return get_summary_report_definition_impl(tables_gb10b, tables_common)
